...
from data_preparation_imdb import prepare_data
...
def predict_imdb_rating():
    ...
    df = pd.read_csv(f'{processed_path}/rfr_novo_filme_processed.csv')
...
if __name__ == "__main__":
    ...
    name_file_processed = 'rfr_novo_filme_processed.csv'
